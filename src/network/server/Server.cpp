...
//                    const float DEAD_ZONE = SCREEN_W / 3.f;
//                    const float LEFT_WORLD = 0.f;
//                    const float RIGHT_WORLD = 2000.f;
//
//                    if (slots[i].camX == 0.f)
...
//
//                    float screenLeftEdge = camX - SCREEN_W / 2.f + DEAD_ZONE;
//                    float screenRightEdge = camX + SCREEN_W / 2.f - DEAD_ZONE;
//
//                    // Clamp player to dead‑zone edge so they can't walk past it on screen
//                    if (playerX < screenLeftEdge)
//                        playerX = screenLeftEdge;
//                    else if (playerX > screenRightEdge)
//                        playerX = screenRightEdge;
//
//                    // Now update camera to follow the clamped player
//                    camX = playerX - (SCREEN_W / 2.f - DEAD_ZONE);   // this is the same formula, just simplified
//
...
//                    // ----------------------------------------------------------------
//
//                    // Visibility culling (unchanged, uses the new camera)
...
//                        sendDestroy(i, { id });
//
//                    // Build snapshot (unchanged, but with camera quantised)
//                    FrameSnapshot snap;
...
//                        udp_socket.send(snapPacket, slots[i].ip.value(), slots[i].udpPort);
//                    }
//                }
//            }
//         }
