    ...
    while (window.isOpen()) {
        ...
        if (window.hasFocus()) {
            ...
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Right) ||
                sf::Keyboard::isKeyPressed(sf::Keyboard::Key::D)) input += 'R';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Up) ||
                sf::Keyboard::isKeyPressed(sf::Keyboard::Key::W)) input += 'U';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Down) ||
                sf::Keyboard::isKeyPressed(sf::Keyboard::Key::S)) input += 'N';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Space)) input += 'J';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::J)) input += '1';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::K)) input += '2';
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::L)) input += '3';
